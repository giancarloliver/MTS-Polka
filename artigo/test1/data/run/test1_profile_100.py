...
Original file is located at
    https://colab.research.google.com/drive/1mmPiNV9sFbvY69iKEoXPfo9qwZ5NqvfW
"""
...
arq ='drive/MyDrive/Colab Notebooks/Teste_Traffic_M-Polka/IdPerfil-4/f-4-tmp.bwm'
...
df_sw4 = data[data['interface'].str.contains('s2_2-eth')]
...
switch_colors = {'s1_0': 'blue', 's2_0': 'gray','s2_2': 'orange','s2_4': 'green', 's1_1': 'red'}
...
#ax.set_title('Teste de funcionalidade do perfil 4', fontsize=18)

# Create custom legend handles and labels
legend_handles = [plt.Rectangle((0, 0), 1, 1, color=color) for color in switch_colors.values()]
legend_labels = [f"{switch} ({packets_out} packets_out)" for switch, packets_out in zip(df['Switches'], df['packets_out'])]
