...
Original file is located at
    https://colab.research.google.com/drive/1SPv4gg7tudbJxyvCjQkvazczCeM4tt6l
"""
...
switch_colors = {'s1_0': 'blue', 's2_2': 'orange', 's1_1': 'red'}
...
#ax.set_title('Teste de funcionalidade do perfil 0', fontsize=18)
...
#ax.legend(legend_handles, legend_labels, fontsize=18, loc='upper right', bbox_to_anchor=(0.8, 0.5))
